...
<div class="col-xs-12" style="margin-top:15px">
	<?if($_SESSION['admin']==1){?>
		...
		<div data-id="text" class="hidden">
			<form method="post" action="?task=instruction&edit=1">
				<textarea id="instruction" name="content"><?readfile($data)?></textarea>
				<div class="col-xs-12" style="text-align: right;margin-top:15px">
					<a href="?task=instruction" class="btn btn-default">Отмена</a>
