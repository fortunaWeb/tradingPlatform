    ...
    <div class="btn-group medium" data-toggle="buttons" style=" width: 99%">
        <label data-id="user_id"
            ...
            <input type="radio" name="search_user_id" value="site"
                <?php if ($_GET['action'] == "index") echo "checked"; ?>>агентства1
        </label>
        <label data-id="user_id"
...
<div class="btn-group medium" data-toggle="buttons" style = " width: 99%">	
	<label data-id="user_id" onClick="window.location='/?task=main&action=index&parent_id=<?=$parent_id?>&topic_id=<?=$topic_id?>'" 
				class="btn btn-default 
					<?php if( 
