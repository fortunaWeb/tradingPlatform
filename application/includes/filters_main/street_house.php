...
<? if($_SESSION['mobile']==1){ ?><div class="col-xs-1 deployed" style = 'width:99%;'><?}?>
	...
	if($_GET['action'] == 'index' || $_GET['action'] == 'mytype'){
		...
		echo ' onKeyup="sendParseSearchBuysell()"';
	}else{
		echo ' onKeyup="sendParseSearch()"';
	}
...
<div class="col-xs-1 deployed" style = 'margin-right: <?=$_SESSION['mobile']==1?"auto;'":"auto;"?>'>
	...
	<input type="text" name="house" class="form-control" placeholder="Дом"  <?=$_SESSION['mobile']==1?'style = "width: 80px "':''?>
