<div class="col-xs-2 deployed" style ='
		<?=$_SESSION['mobile']==1?'width: 15%;margin-right: 1%;':'min-width: 130px !important; max-width: 130px;'?>
	'>
	<label class="signature">Кого берут</label>	
	<input type="hidden" class="form-control" name="residents" value="<?php echo Helper::FilterVal('residents'); ?>" required>
	<div class="form-control" style="cursor:pointer; padding:2px; overflow:hidden;" id="residents">
		<span class="placeholderSpan">кого берут</span>
	</div>
