...
<div class="btn-group btn-group-justified count" role="group" aria-label="...">
  <div class="btn-group" role="group" data-toggle="buttons">
    ...
    <label class="btn btn-default <?php if($_GET['action'] == "copyright") echo "active"; ?>" style="width: 14%;" data-href="<?echo "?task=profile&action=mytype&copyright=1&active=1".$url;?>">
		<input type="radio" name="copyright" value="1" <?php if($_GET['action'] == "copyright") echo "checked"; ?>>Скопированные
	</label>
