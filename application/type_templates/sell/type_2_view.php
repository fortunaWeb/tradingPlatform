...
<fieldset>
	...
	<div class="control-group">
		<label class="control-label" id="developer">Застройщик</label>
		<input id="developer" name="developer" type="text" value="<?php if($data_res['developer']) echo $data_res['developer']; ?>" />  <br />
		<div class="header-3">
			Сдача
		</div>
		<label class="control-label" id="y_done">Год</label>
		<input id="construct_y" name="construct_y" type="text" value="<?php if($data_res['developer']) echo $data_res['developer']; ?>" />
		
		<label class="control-label" id="quarter">Квартал</label>
		
			<select class="controls-select" name="quarter" id="quarter" >
				<option value="1"  <?php if($data_res['quarter'] == '1') echo "selected"; ?> >1 (январь-март)</option>
				<option value="2" <?php if($data_res['quarter'] == '2') echo "selected"; ?> >2 (апрель-июнь)</option>
				<option value="3" <?php if($data_res['quarter'] == '3') echo "selected"; ?> >3 (июль-сентябрь)</option>
				<option value="4" <?php if($data_res['quarter'] == '4') echo "selected"; ?> >4 (октябрь-декабрь)</option>
			</select>
